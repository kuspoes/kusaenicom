...
---
 ...
 <p>Namun setelah versi 0.20 Gotosocial sudah menyertakan fitur notifikasi sehingga cara yang dijelaskan di artikel ini sudah tidak relevan lagi. Namun masih bagus untuk dijadikan bahan pembelajaran dan masih bisa dipakai dengan baik.</p>
  </div>

~~Sampai dengan rilis [v.0.16.0](https://github.com/superseriousbusiness/gotosocial/releases/tag/v0.16.0)~~ Gotosocial ~~masih belum~~ menyertakan fitur _push notification_ dalam aplikasinya. Menurut salah satu _developer_-nya pengaktifan notifikasi membutuhkan banyak sumber daya karena harus merubah sebagian besar kode meski sebenarnya Gotosocial sendiri sudah mendukung [API untuk mengirim notifikasi](https://docs.gotosocial.org/en/latest/api/swagger/).
