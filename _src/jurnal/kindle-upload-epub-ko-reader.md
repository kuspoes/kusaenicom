...
![Ko Reader: pengaturan SSH Server]({{ metadata.imgdia }}jurnal/kindle/Reader_The%20Name%20of%20the%20Rose_1.webp)
...
![Nimble Commander: setup SFTP ke Ko Reader]({{ metadata.imgdia }}jurnal/kindle/SCR-20251116-rwzy_nxtACN6tM.webp)
...
![Nimble: Copy paste ebook ke dalam folder Buku di Ko Reader/Kindle]({{ metadata.imgdia }}jurnal/kindle/SCR-20251116-rwmm_K5XwcW7DQ.webp)
